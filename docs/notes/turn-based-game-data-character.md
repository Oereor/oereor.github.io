...
读完了[技能配置的解析](#技能配置)之后，你应该能自己解析[星魂配置](#星魂配置)了。
...
星魂的配置和技能是类似的（并且简单很多）。如果你已经完整地读过上面技能配置的解析，就应当能自己把星魂的配置解读出来。

星魂配置位于 `AvatarRankConfig.json`。在这里放一个遐蝶的 2 魂作为例子，不妨自己试试。
...
```
{
    ...
    "Name": "AvatarRankName_140702",
    "Desc": "AvatarRankDesc_140702",
    "ExtraEffectIDList": [
      10000001
    ],
    "IconPath": "SpriteOutput/SkillIcons/Avatar/1407/SkillIcon_1407_Rank2.png",
    "SkillAddLevelList": {},
    "RankAbility": [],
    "UnlockCost": [
      {
